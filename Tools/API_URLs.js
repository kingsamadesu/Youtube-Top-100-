API_Key = "AIzaSyBp-sUUbNlI-aCounGzGbvzvlybf_SboAg"
...
function get_Url_commentThreads(videoId) {
    return "https://www.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&videoId=" + videoId + "&maxResults=50&key=" + API_Key
}
